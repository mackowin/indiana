<template>
    ...
    <div class="pricing-table col-xl-6 col-md-8 col-12 offset-xl-3 offset-md-2 offset-0" style="margin-top: 5rem; padding-top: 1.8rem; padding-left: 0px; padding-right: 0px">
        <div class="price" style="margin-bottom: 0;">
            <span v-if="secondCount > 0 && secondCount < 864000" style="color: #0b5345"><sup>$</sup>55
                <sup style="color: #b30000; font-size: 13px; margin-left: 3px">$</sup><span style="color: #b30000; font-size: 16px; text-decoration: line-through">99</span>
            </span>
            <span v-if="secondCount <= 0 || secondCount >= 864000" style="color: #0b5345"><sup>$</sup>99</span>
        </div>

        <div v-show="secondCount > 0 && secondCount < 864000" style="margin-top: 0.4rem; margin-bottom: 3rem; font-size: 14px; color: #0b5345">
            <span>Valid for: </span>
            <span>
        ...
        <div v-if="secondCount <= 0 || secondCount >= 864000" class="row banner-action-btns" style="text-align: center; margin-top: 1rem">
            <a href="https://buy.stripe.com/3cs7wm0La2cC04o7st" class="btn btn-primary" style="background: #DDAC4A;" :disabled="account.status.applying">Buy Investor Kit
        ...
        <div v-if="secondCount > 0 && secondCount < 864000" class="row banner-action-btns" style="text-align: center; margin-top: 1rem">
            <a href="https://buy.stripe.com/cN22c279y8B0bN66oo" class="btn btn-primary" style="background: #DDAC4A;" :disabled="account.status.applying">Buy Investor Kit
                <img v-show="account.status.applying" src="data:image/gif;base64," />
            </a>
        </div>
    ...
    export default {
        ...
        data () {
            return {
              ...
              event: new Date('2022-10-04T10:10:00'),
              finish: true,
              submitted: false
            }
          },
