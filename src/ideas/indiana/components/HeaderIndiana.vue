            ...
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    <router-link class="navbar-brand" to="/">
                        <img width="110px" src="./../resources/indy-invest-logo.svg"/>
                    </router-link>
                    ...
                    <b-collapse class="collapse navbar-collapse mean-menu" id="navbarSupportedContent" is-nav>
                        <ul class="navbar-nav nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="/" class="nav-link" v-scroll-to="'#kit'">Investor Kit</a>
                            </li>
                            <li class="nav-item">
                                <a href="/" class="nav-link" v-scroll-to="'#indianapolis'">Indianapolis</a>
                            </li>
                            <li class="nav-item">
                                <a href="/" class="nav-link" v-scroll-to="'#about'">About Us</a>
                            </li>
                            <li class="nav-item">
